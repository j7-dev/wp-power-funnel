...
const releasedPluginName = 'power-funnel'
...
module.exports = {
    ...
    hooks: {
        ...
        'after:bump': [
            ...
            `cd release/${releasedPluginName}/${releasedPluginName} && composer install --no-dev && composer strauss && composer rm:dir -- --dir=bin`,
            'echo ✅ composer install success',
            'echo ✅ composer strauss success',
            'cd ../..',
